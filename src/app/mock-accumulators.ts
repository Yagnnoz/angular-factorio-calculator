...
export const ACC_BOBS: AccumulatorInterface[] = [
  ...
  {id: 5, name: 'High Capacity MK 1', capacityInMJ: 10},
  {id: 6, name: 'High Capacity MK 2', capacityInMJ: 15},
  {id: 7, name: 'High Capacity MK 3', capacityInMJ: 22.5},
  {id: 8, name: 'Fast MK 1', capacityInMJ: 4},
  {id: 9, name: 'Fast MK 2', capacityInMJ: 6},
  {id: 10, name: 'Fast MK 3', capacityInMJ: 9}
]
